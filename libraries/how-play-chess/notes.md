...
To further develop your chess strategy, you should consider the guides on
[lichess.org][1] or any book written by a grandmaster (which I am not). I
personally credit my library’s copy of _Bobby Fischer Teaches Chess_ as one
of the most rewarding chess books I’ve read.

[1]: https://lichess.org/

Feel free to use this text to develop your own handouts or teaching aides. I
adapted everything from other resources (not the least of which was [good old
Wikipedia][2]).

[2]: https://en.wikipedia.org/wiki/Glossary_of_chess

I generated all of the board diagrams with [python-chess][3]. In the original
handout, the diagrams are simply tables made in Microsoft Word, which seemed
hardly worth the frustration.
