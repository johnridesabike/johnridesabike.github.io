...
<div class="wp-block-image">
    <figure class="aligncenter" style="text-align:center">
        <img src="./chess-guide-media/chess_start.svg" alt="Chess starting position."/>
    </figure>
</div>
...
<div class="wp-block-image">
    <figure class="alignright">
        <img src="./chess-guide-media/chess_King.svg" alt="The king’s moves."/>
    </figure>
</div>
...
<div class="wp-block-image">
    <figure class="alignright">
        <img src="./chess-guide-media/chess_Queen.svg" alt="The queen’s moves."/>
    </figure>
</div>
...
<div class="wp-block-image">
    <figure class="alignright">
        <img src="./chess-guide-media/chess_Rook.svg" alt="The rook’s moves." />
    </figure>
</div>
...
<div class="wp-block-image">
    <figure class="alignright">
        <img src="./chess-guide-media/chess_Bishop.svg" alt="The bishop’s moves." />
    </figure>
</div>
...
<div class="wp-block-image">
    <figure class="alignright">
        <img src="./chess-guide-media/chess_Knight.svg" alt="The knight’s moves."/>
    </figure>
</div>
...
<div class="wp-block-image">
    <figure class="aligncenter">
        <img src="./chess-guide-media/chess_Pawn.svg" alt="The pawn’s moves." />
        <figcaption>
...
<div class="wp-block-columns has-2-columns">
    <div class="wp-block-column">
        <div class="wp-block-image">
            <figure class="aligncenter">
                <img src="./chess-guide-media/chess_Castling-part-1.svg" alt="The position before castling."/>
    ...
    <div class="wp-block-column">
        <div class="wp-block-image">
            <figure class="aligncenter">
                <img src="./chess-guide-media/chess_Castling-part-2.svg" alt="The position after castling." />
...
<div class="wp-block-columns has-2-columns">
    <div class="wp-block-column">
        <div class="wp-block-image">
            <figure class="aligncenter">
                <img src="./chess-guide-media/chess_En-passant-part-1.svg" alt="The position before en passant." />
                <figcaption>
    ...
    <div class="wp-block-column">
        <div class="wp-block-image">
            <figure class="aligncenter">
                <img src="./chess-guide-media/chess_En-passant-part-2.svg" alt="The position after en passant."/>
                <figcaption>
...
<div class="wp-block-image">
    <figure class="alignright">
        <img src="./chess-guide-media/chess_Checkmate.svg" alt="A checkmate position."/>
        <figcaption>
...
<div class="wp-block-image">
    <figure class="alignright">
        <img src="./chess-guide-media/chess_Stalemate.svg" alt="A stalemate position."/>
        <figcaption>
...
<div class="wp-block-image">
    <figure class="alignright">
        <img src="./chess-guide-media/chess_Fork.svg" alt="A fork position." />
        <figcaption>
...
<div class="wp-block-image">
    <figure class="alignright">
        <img src="./chess-guide-media/chess_Pin.svg" alt="A pin position."/>
